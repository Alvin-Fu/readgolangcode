...
type Type interface {
	...
	//
	// For a non-interface type T or *T,
	// the returned Method's Type and Func fields describe a function whose first argument is the receiver.
	//
...
func TypeOf(i interface{}) Type {
	//使用unssfe.Pointer进行指针转换，类似于c中的void*万能指针
