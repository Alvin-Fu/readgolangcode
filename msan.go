...
// We don't instrument the runtime,
// but operations like a slice copy can call msanread anyhow for values on the stack.
// Just ignore msanread when running on the system stack. The other msan functions are fine.
//
//go:nosplit
